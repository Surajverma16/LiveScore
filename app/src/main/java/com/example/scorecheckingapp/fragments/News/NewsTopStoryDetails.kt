...
class NewsTopStoryDetails(val topStory: TopStory) : Fragment() {
    lateinit var binding1: ListNewsDetailsBinding
    ...
    override fun onCreateView(
        ...
        binding1 = ListNewsDetailsBinding.inflate(layoutInflater,container,false)
        getNewsDetails()
        ...
        retrofitNews?.enqueue(object : Callback<details?> {
            override fun onResponse(call: Call<details?>, response: Response<details?>) {
                ...
                Glide.with(context!!)
                    ...
                    .into(binding1.newsDetailsImage)

                binding1.newsDetailsImageDescriptionText.text = responseBody.article.mainMedia.gallery.alt
                ...
                binding1.run { newsDetailsDescriptionText.setText(Html.fromHtml(sw.toString())) }
